...
// Utilitário padrão para permitir Polimorfismo com Gson
public final class GsonRuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    private GsonRuntimeTypeAdapterFactory(Class<T> baseType, String typeFieldName) {
    ...
    public static <T> GsonRuntimeTypeAdapterFactory<T> of(Class<T> baseType, String typeFieldName) {
        return new GsonRuntimeTypeAdapterFactory<>(baseType, typeFieldName);
    }

    public static <T> GsonRuntimeTypeAdapterFactory<T> of(Class<T> baseType) {
        return new GsonRuntimeTypeAdapterFactory<>(baseType, "type");
    }

    public GsonRuntimeTypeAdapterFactory<T> registerSubtype(Class<? extends T> type, String label) {
    ...
    public GsonRuntimeTypeAdapterFactory<T> registerSubtype(Class<? extends T> type) {
    ...
    public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
        ...
        return new TypeAdapter<R>() {
            ...
            @Override public void write(JsonWriter out, R value) throws IOException {
                ...
                TypeAdapter<Object> delegate = (TypeAdapter<Object>) subtypeToDelegate.get(srcType);
                if (delegate == null) {
